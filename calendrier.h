...
Description    : Ce fichier contient les déclarations de toutes les fonctions
                 implémentées dans calendrier.cpp. Elles permettent l'affichage d'un
                 calendrier.

Remarque(s)    : Les bornes de ces fonctions sont définies par ANNEE_MIN et
                 ANNEE_MAX. Attention : ne pas définir une valeur en dessous de
                 1582 pour ANNEE_MIN car le programme ne donnera plus les bonnes
                 valeurs. De même pour ANNEE_MAX, ne pas mettre une valeur plus
                 grande que la valeur max d'un unsigned int - 1.

Compilateur    : Mingw-w64 g++ 8.1.0
-----------------------------------------------------------------------------------
*/
using namespace std;
#ifndef LABO_3_CALENDRIER_H
#define LABO_3_CALENDRIER_H
